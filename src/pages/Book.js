    ...
    <section class="books">
        <div className="row">
            ...
            <ul className="cards">
                <li>
                    <div className="card">
                        <img src="assets/img/car/car1.jpg" className="card__image" alt="" />
                        <div className="card__overlay">
                            <div className="card__header">
                                <svg className="card__arc" xmlns="http://www.w3.org/2000/svg"><path /></svg>

                                <div className="card__header-text">
                                    <h3 className="card__title"> <Link to="./Choosecar"  className='link'>Car Services</Link></h3>
                                </div>
                            </div>
                ...
                <li>
                    <div className="card">
                        <img src="assets/img/brands/megu2.jpg" className="card__image" alt="" />
                        <div className="card__overlay">
                            <div className="card__header">
                                <svg className="card__arc" xmlns="http://www.w3.org/2000/svg"><path /></svg>

                                <div className="card__header-text">
                                    <h3 className="card__title"><Link to="./Service"  className='link'>Cleaning Services</Link></h3>
                ...
                <li>
                    <div className="card">
                        <img src="assets/img/car/bike.jpg" className="card__image" alt="" />
                        <div className="card__overlay">
                            <div className="card__header">
                                <svg className="card__arc" xmlns="http://www.w3.org/2000/svg"><path /></svg>

                                <div className="card__header-text">
                                    <h3 className="card__title"><Link to="./Service" className='link'>Bike Services</Link> </h3>
